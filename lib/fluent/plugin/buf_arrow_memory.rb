...
module Fluent
  module Plugin
    class ArrowMemoryBuffer < Fluent::Plugin::Buffer
      ...
      config_param :store_as, :enum, list: [:text, :gzip], default: :text
      config_param :row_group_chunk_size, :integer, default: 8192
      ...
      def generate_chunk(metadata)
        Fluent::Plugin::Buffer::ArrowMemoryChunk.new(metadata, @arrow_schema, chunk_size: @row_group_chunk_size, format: @arrow_format, store_as: @store_as, log: log)
      end
    end
  end
end
